...
class Encoder(nn.Module):
    def __init__(self, enc_in, enc_out, n_dim, leaky_relu_alpha=0.3):
        ...
        self.batch = nn.BatchNorm2d(n_dim)
        self.batch_1 = nn.BatchNorm2d(n_dim)
        self.batch_2 = nn.BatchNorm2d(n_dim)
        self.batch_3 = nn.BatchNorm2d(n_dim)
        self.batch_4 = nn.BatchNorm2d(n_dim)
        self.batch_5 = nn.BatchNorm2d(n_dim)
        self.batch_6 = nn.BatchNorm2d(n_dim)
        self.batch_7 = nn.BatchNorm2d(n_dim)
        self.batch_8 = nn.BatchNorm2d(n_dim)
        self.batch_mu = nn.BatchNorm2d(enc_out)
...
class Decoder(nn.Module):
    ...
    def __init__(self, dec_in, dec_out, n_dim, leaky_relu_alpha=0.3):
        ...
        self.conv2d_transpose_1 = nn.ConvTranspose2d(n_dim, n_dim, kernel_size=(3,3), stride=1, padding=1)
