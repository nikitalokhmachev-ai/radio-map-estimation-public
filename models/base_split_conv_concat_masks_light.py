...
class Encoder(nn.Module):
    def __init__(self, enc_in, enc_out, n_dim_map, n_dim_mask, leaky_relu_alpha=0.3):
        ...
        self.conv2d_1 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
        self.conv2d_2 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
        ...
        self.conv2d_4 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
        self.conv2d_5 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
        ...
        self.conv2d_7 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
        self.conv2d_8 = nn.Conv2d(n_dim_map, n_dim_map, kernel_size=(3, 3), padding='same')
