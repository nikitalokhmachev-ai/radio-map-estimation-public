...
class Encoder(nn.Module):
    def __init__(self, enc_in, enc_out, n_dim, leaky_relu_alpha=0.3):
        ...
        self.conv2d_2 = nn.Conv2d(2 * n_dim, n_dim, kernel_size=(3, 3), padding='same')
        ...
        self.conv2d_5 = nn.Conv2d(2 * n_dim, n_dim, kernel_size=(3, 3), padding='same')
        ...
        self.conv2d_8 = nn.Conv2d(2 * n_dim, n_dim, kernel_size=(3, 3), padding='same')
...
class Decoder(nn.Module):
    ...
    def __init__(self, dec_in, dec_out, n_dim, leaky_relu_alpha=0.3):
        ...
        self.conv2d_transpose_3 = nn.ConvTranspose2d(2 * n_dim, n_dim, kernel_size=(3,3), stride=1, padding=1)
        ...
        self.conv2d_transpose_6 = nn.ConvTranspose2d(2 * n_dim, n_dim, kernel_size=(3,3), stride=1, padding=1)
        self.conv2d_transpose_7 = nn.ConvTranspose2d(2 * n_dim, n_dim, kernel_size=(3,3), stride=1, padding=1)
        self.conv2d_transpose_8 = nn.ConvTranspose2d(2 * n_dim, n_dim, kernel_size=(3,3), stride=1, padding=1)
