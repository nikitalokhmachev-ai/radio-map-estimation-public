...
from .sparse_scaled import SparseScaledConv2d
...
class Encoder(nn.Module):
    def __init__(self, enc_in, enc_out, n_dim, scale=9, leaky_relu_alpha=0.3):
        ...
        self.conv2d = SparseScaledConv2d(enc_in, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_1 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_2 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_3 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_4 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_5 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_6 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_7 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.conv2d_8 = SparseScaledConv2d(n_dim, n_dim, kernel_size=(3, 3), padding='same', scale=scale)
        self.mu = SparseScaledConv2d(n_dim, enc_out, kernel_size=(3, 3), padding='same', scale=scale)
